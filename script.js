...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (!window.zappyContactFormLoaded) {
        console.log('⚠️ Zappy: Duplicate prevention flag not set, skipping API call');
      } else {
        (async function() {
          try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: 'e947c28d-e923-40eb-962c-3171505a8a9d',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מאור מסגרות ובניו משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
